...
import { sendEmail, isEmailLiveMode, renderBrandedEmail } from './email.js'
...
export const __testing = { render, formatHkTime, TEMPLATES, channelResult, setServiceClient: client => { injectedServiceClient = client } }
