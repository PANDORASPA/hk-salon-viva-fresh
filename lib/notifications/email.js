 ...
 */
export async function sendEmail({ to, subject, html, text, preheader, idempotencyKey }) {
...
export const __testing = {
  isEmailLiveMode, getEnv, escapeHtml, stripHtml, renderBrandedEmail, sanitizeProviderReason,
  setResendClient: client => { resendClient = client; modeCache = client ? true : null },
}
