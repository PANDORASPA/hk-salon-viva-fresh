...
function normaliseKey(key, value) {
  if (NUMERIC_KEYS.has(key)) {
    ...
    const ranges = { booking_buffer_minutes: [0, 240], slot_step_minutes: [5, 120], minimum_lead_minutes: [0, 10080], maximum_advance_days: [1, 730], reminder_hours_before: [1, 168], cancel_cutoff_hours: [0, 168] }
